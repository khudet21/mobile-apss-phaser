...
export default defineComponent({
  ...
  setup() {
    onMounted(() => {
      ...
      var jumlahBenda
      var jumlahBendaLain
      var isPanelBenda1Correct
      var panelBenda1, panelBenda2, textPanelBenda1, textPanelBenda2
      ...
      function create() {
        ...
        var scoreText = this.add
          ...
          .setDepth(2)
        var currentQuestionText = this.add.text(
        ...
        const gameOver = (scene, skorAkhir) => {
          ...
          const addParticles = (scene, x, y) => {
            ...
            let emitter = particlesManager.createEmitter({
              x: x,
              y: y,
